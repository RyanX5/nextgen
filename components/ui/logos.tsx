...
export default function LogoSection() {
    return (
        <div className="relative text-center flex flex-col items-center justify-center bg-foreground text-background py-4 px-4 md:py-8 gap-6 tracking-tighter">
            ...
            <ul className='flex gap-4 md:gap-16 items-center justify-center max-w-6xl brightness-0 invert dark:invert-0'>
